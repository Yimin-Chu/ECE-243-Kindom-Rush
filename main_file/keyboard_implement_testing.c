...
int monster_x = 47;   // Starting X (left-bottom of road)
int monster_y = 185;  // Starting Y
int dx = 0, dy = 0;   // Movement direction (will be set in update_monster_position)
bool monster_finished = false;

// Define double-buffering arrays (each buffer holds a frame; adjust dimensions as needed)
