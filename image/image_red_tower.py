...
if __name__ == '__main__':
    convert_img(
        file_name='C:/Users/peter/Desktop/ece243-image/red_tower.png',  # <- your PNG with transparency
        img_name='tower2',
        width=26,
        height=42,
        bg_rgb=(253, 244, 200)  # default background for transparent pixels (greenish)
    )
